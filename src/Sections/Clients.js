...
import { client } from '../Plots/export'; // Adjust the path based on your project structure
...
const Clients = ()=>{
    ...
    return(
        <div className={`${darkMode ? 'dark bg-black ' : 'light bg-transparent'}`}>
         <section id='testimonals' className='lg:w-[95%] w-full h-fit m-auto bg-cover
         bg-center rounded-xl flex justify-center flex-col  items-start lg:px-20 px-6 py-20 gap-20'>
            <div className='flex flex-col justify-center items-start gap-4'>
                <h1 data-aos='zoom-in' className='text-red-500 dark:text-white'>CLIENTS</h1>
                <h1 data-aos='zoom-in' className='text-black dark:text-white text-[40px] 
                font-semibold leading-10'>what our clients<br></br> saying about us</h1>
            </div>
  ...
  client.map((item, index) => (
    <div
      ...
      data-aos-delay="200"
      key={index}
      className="bg-white dark:bg-gray-900 hover:bg-red-100 cursor-pointer p-12 flex flex-col justify-center items-center gap-6 rounded-s-xl w-full"
    >
