...
//   return (
//     <div className="max-w-7xl mx-auto p-8 mt-17 bg-white rounded-lg shadow-lg">
...
const Project1 = () => {
  ...
  return (
    <div className="project-container">
      ...
      {/* Highlights Section */}
      <div className="section highlights-section">
        <h3 className="section-title">Project Highlights</h3>
        <p className="highlight-item"><strong>Premium DC Conversion Plots</strong></p>
        <p className="highlight-item"><strong>Location:</strong> Kumbalgodu, Mysore Road</p>
        <p className="highlight-item"><strong>Total Area:</strong> 8 Acres, 2.5 Guntas</p>
        <p className="highlight-item"><strong>Total Plots:</strong> 219</p>
      </div>

      {/* Plot Dimensions Section */}
      <div className="section plot-dimensions-section">
        <h3 className="section-title">Plot Dimensions</h3>
      ...
      <div className="section nearby-locations-section">
        <h3 className="section-title">Nearby Locations</h3>
        <ul className="locations-list">
          <li>Christ School, BGS International School</li>
          {/* Add other location items */}
        </ul>
      </div>
      ...
      {/* Registration and Payment Details */}
      <div className="section registration-payment-section">
        <h3 className="section-title">Ready for Registration & Construction</h3>
        <p className="bank-loan-info"><strong>Bank Loan:</strong> Approved by IDBI and all leading banks up to 70%</p>
        <p className="payment-options"><strong>Payment Options:</strong> Cheque, Cash, and Online</p>
      </div>

      {/* Contact Section */}
      <div className="contact-section">
        <h3 className="contact-title">Contact Us Today for More Details!</h3>
      </div>
    </div>
  );
};
